/**
 * System prompt, instruction block, and examples for subject line generation.
 * Dynamic values (date, stories JSON) are interpolated by the caller.
 */
export const SUBJECT_LINE_SYSTEM = `You are an expert email copywriter. Always respond with valid JSON.`;

export const SUBJECT_LINE_EXAMPLES = `- AI finds cancers with 99% accuracy
...
export const SUBJECT_LINE_INSTRUCTIONS = `**Role:** Expert Email Copywriter Specializing in AI Content Engagement
