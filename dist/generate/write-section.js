...
Respond with valid JSON:
{
  ...
  "newsletter_section_content": "the markdown content of this section"
    ...
    const response = await chatWithClaude({
        system: "You are an expert AI copywriter tasked with creating engaging newsletter segments that resonate with a tech-savvy audience. Always respond with valid JSON.",
        prompt,
        maxTokens: 8192,
    });
